classdef ACEParameters
    
    properties
        m=22; % No. of available electrodes. For Cochlear = 22.
        ...
        T = 100+zeros(22,1); %100 CU
        C = 800+zeros(22,1); %700 CU
        ...
        CompFac=340.83; % Compression Factor that defines steepness of loudness growth function
        vol = 1% volume control limits C-level: 1 = full dynamic range is used
        brand = 1 %randomization of pulse-pattern on (1) or off (0), for Auralization part of the vocoder this should be set to 1
    end
end
